...
> **状态：public preview。项目已进入 STEP0 实施阶段，包含 monorepo 工具链、schema 真源/codegen、CI、redline guard 和 Tier 1 MVP 计划。核心视频翻译/配音管线仍在分阶段移植中。**
...
> **open/private 模块边界遵循 AD-14。** 控制面的 provider key / 计费 / 风控 / 托管调度策略**不进**开源默认配置。
